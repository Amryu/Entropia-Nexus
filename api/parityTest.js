...
const endpoints = [
  ...
  { base: '/signs', single: '/signs/{key}' },
  { base: '/strongboxes', single: '/strongboxes/{key}' },
  { base: '/storagecontainers', single: '/storagecontainers/{key}' },
  ...
  { base: '/skillcategories', single: '/skillcategories/{key}' },
  { base: '/skills', single: '/skills/{key}' },
  { base: '/vehicleattachmenttypes', single: '/vehicleattachmenttypes/{key}' },
  { base: '/vehicles', single: '/vehicles/{key}' },
  ...
  { base: '/vendoroffers', single: '/vendoroffers/{key}' },
