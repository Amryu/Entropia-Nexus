...
const ENRICHMENT_MAP = {
  ...
  Mob:          { route: '/mobs',          tables: ['Mobs', 'MobSpecies', 'Planets', 'Professions', 'MobLoots', 'MobMaturities', 'MobSpawns', 'Locations', 'Areas', 'MobSpawnMaturities', ...ITEM_TABLES], getter: getMobs },
  MobMaturity:  { route: '/mobs',          tables: ['Mobs', 'MobSpecies', 'Planets', 'Professions', 'MobLoots', 'MobMaturities', 'MobSpawns', 'Locations', 'Areas', 'MobSpawnMaturities', ...ITEM_TABLES], getter: getMobs },
