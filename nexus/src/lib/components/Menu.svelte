<script lang="ts">
  ...
  const wikiColumns: WikiColumn[] = [
    {
      ...
      items: [
        ...
        { label: 'Tools', url: 'tools', children: [
          ...
          { label: 'Fishing Rods', url: 'tools/fishingrods' },
        ]},
        { label: 'Attachments', url: 'attachments', children: [
          ...
          { label: 'Fishing Reels', url: 'attachments/fishingreels' },
          { label: 'Fishing Blanks', url: 'attachments/fishingblanks' },
          { label: 'Fishing Lines', url: 'attachments/fishinglines' },
          { label: 'Fishing Lures', url: 'attachments/fishinglures' },
        ]},
        { label: 'Blueprints', url: 'blueprints', children: [
          ...
          { label: 'Fishing Gear', url: 'blueprints?Properties.Type=Fishing%20Gear' },
          { label: 'Fishing Attachment', url: 'blueprints?Properties.Type=Fishing%20Attachment' },
          { label: 'Gastronomer', url: 'blueprints?Properties.Type=Gastronomer' },
          { label: 'Provisioner', url: 'blueprints?Properties.Type=Provisioner' },
          { label: 'Nutritionist', url: 'blueprints?Properties.Type=Nutritionist' },
        ]},
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Fishes', url: 'fishes', children: [
          { label: 'Sea', url: 'fishes?Properties.Biome=Sea' },
        ...
        { label: 'Professions', url: 'professions', children: [
          ...
          { label: 'Construction', url: 'professions?Category.Name=Construction' },
  ...
  const WIKI_POPOUT_ENDPOINTS: Record<string, WikiPopoutEndpoint[]> = {
    ...
    'Tools': [
      ...
      { endpoint: '/fishingrods',        sub: 'Rod',         urlPrefix: '/items/tools/fishingrods' },
    ],
    'Attachments': [
      ...
      { endpoint: '/fishingreels',            sub: 'Reel',       urlPrefix: '/items/attachments/fishingreels' },
      { endpoint: '/fishingblanks',           sub: 'Blank',      urlPrefix: '/items/attachments/fishingblanks' },
      { endpoint: '/fishinglines',            sub: 'Line',       urlPrefix: '/items/attachments/fishinglines' },
      { endpoint: '/fishinglures',            sub: 'Lure',       urlPrefix: '/items/attachments/fishinglures' },
    ],
    ...
    'Fishes':      [{ endpoint: '/fishes',       urlPrefix: '/information/fishes' }],
...
<style>
  ...
  .globals-menu-type.type-fish      { background: rgba(6, 182, 212, 0.15);  color: #06b6d4; }
