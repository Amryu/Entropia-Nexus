...
<svelte:head>
  <title>Client (Beta) - Entropia Nexus</title>
  <meta name="description" content="Download the Entropia Nexus desktop client (beta) — in-game wiki, overlays, exchange market, loadout manager, OCR skill scanner, and automatic updates." />
  ...
  <section class="section">
    ...
    <div class="downloads-grid">
      ...
      <a href="https://github.com/Amryu/Entropia-Nexus" class="download-card" target="_blank" rel="noopener noreferrer">
        ...
        <div class="download-info">
          <span class="download-name">Build from source</span>
          <span class="download-note">View on GitHub</span>
        </div>
        <span class="download-arrow source-arrow">→</span>
      </a>
    </div>
...
<style>
  ...
  .download-card:hover .source-arrow {
