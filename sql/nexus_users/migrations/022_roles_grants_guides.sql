...
GRANT SELECT, INSERT, UPDATE, DELETE ON grants TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON roles TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON role_grants TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON user_roles TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON user_grants TO nexus_users;

GRANT USAGE, SELECT ON SEQUENCE grants_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE roles_id_seq TO nexus_users;

-- Guide tables: full CRUD for app
GRANT SELECT, INSERT, UPDATE, DELETE ON guide_categories TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON guide_chapters TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON guide_lessons TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON guide_paragraphs TO nexus_users;

GRANT USAGE, SELECT ON SEQUENCE guide_categories_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE guide_chapters_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE guide_lessons_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE guide_paragraphs_id_seq TO nexus_users;
