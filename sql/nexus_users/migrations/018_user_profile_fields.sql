...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.societies TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.society_join_requests TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.notifications TO nexus_users;

GRANT USAGE, SELECT ON SEQUENCE public.societies_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE public.society_join_requests_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE public.notifications_id_seq TO nexus_users;
