...
GRANT SELECT ON auctions TO nexus_bot;
GRANT UPDATE (discord_message_id) ON auctions TO nexus_bot;
GRANT SELECT ON auction_audit_log TO nexus_bot;
GRANT SELECT ON auction_bids TO nexus_bot;
GRANT USAGE, SELECT ON SEQUENCE auction_audit_log_id_seq TO nexus_bot;
