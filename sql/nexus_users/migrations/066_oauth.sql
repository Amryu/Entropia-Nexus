...
GRANT SELECT, INSERT, UPDATE, DELETE ON oauth_clients TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON oauth_scopes TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON oauth_authorization_codes TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON oauth_access_tokens TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON oauth_refresh_tokens TO nexus_users;

GRANT USAGE, SELECT ON SEQUENCE oauth_scopes_id_seq TO nexus_users;
