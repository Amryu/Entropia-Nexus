...
-- App role
GRANT SELECT, INSERT, UPDATE, DELETE ON inventory_imports TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE inventory_imports_id_seq TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON inventory_import_deltas TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE inventory_import_deltas_id_seq TO nexus_users;
GRANT SELECT, INSERT, UPDATE, DELETE ON unknown_items TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE unknown_items_id_seq TO nexus_users;
GRANT SELECT, INSERT, DELETE ON unknown_item_users TO nexus_users;
