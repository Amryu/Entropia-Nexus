...
GRANT SELECT, INSERT, UPDATE, DELETE ON user_skills TO nexus_users;
GRANT SELECT, INSERT ON skill_imports TO nexus_users;
GRANT SELECT, INSERT ON skill_import_deltas TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE skill_imports_id_seq TO nexus_users;
GRANT USAGE, SELECT ON SEQUENCE skill_import_deltas_id_seq TO nexus_users;
