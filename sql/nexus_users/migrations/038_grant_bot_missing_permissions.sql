-- Migration: Grant missing permissions to nexus_bot
-- Fixes:
...
GRANT SELECT ON item_prices TO nexus_bot;

-- Bot needs to read roles and insert into user_roles during user verification
GRANT SELECT ON roles TO nexus_bot;
GRANT SELECT, INSERT ON user_roles TO nexus_bot;
