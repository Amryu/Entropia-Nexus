-- Migration: Grant permissions to nexus_bot user for nexus_users database
...
GRANT SELECT, INSERT, UPDATE ON users TO nexus_bot;

-- Changes table - bot needs to read and manage change requests
GRANT SELECT, DELETE, UPDATE ON changes TO nexus_bot;
GRANT USAGE, SELECT ON SEQUENCE changes_id_seq TO nexus_bot;
...
GRANT SELECT ON service_ticket_offers TO nexus_bot;
