...
-- Permissions: nexus-users (app) gets read on prices, full on summaries/watermarks
GRANT SELECT ON item_prices TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON item_price_summaries TO "nexus-users";
GRANT SELECT, UPDATE ON item_price_summary_watermarks TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE item_price_summaries_id_seq TO "nexus-users";
