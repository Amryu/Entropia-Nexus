...
-- auctions
GRANT SELECT, INSERT, UPDATE, DELETE ON auctions TO "nexus-users";
GRANT ALL ON auctions TO postgres;

-- auction_bids
GRANT SELECT, INSERT, UPDATE ON auction_bids TO "nexus-users";
GRANT ALL ON auction_bids TO postgres;

-- auction_audit_log
GRANT SELECT, INSERT ON auction_audit_log TO "nexus-users";
GRANT ALL ON auction_audit_log TO postgres;

-- auction_disclaimers
GRANT SELECT, INSERT ON auction_disclaimers TO "nexus-users";
GRANT ALL ON auction_disclaimers TO postgres;

-- Sequence permissions
GRANT USAGE, SELECT, UPDATE ON SEQUENCE auction_audit_log_id_seq TO "nexus-users";
