...
-- rental_offers
GRANT SELECT, INSERT, UPDATE, DELETE ON rental_offers TO "nexus-users";
GRANT ALL ON rental_offers TO postgres;

-- rental_blocked_dates
GRANT SELECT, INSERT, UPDATE, DELETE ON rental_blocked_dates TO "nexus-users";
GRANT ALL ON rental_blocked_dates TO postgres;

-- rental_requests
GRANT SELECT, INSERT, UPDATE, DELETE ON rental_requests TO "nexus-users";
GRANT ALL ON rental_requests TO postgres;

-- rental_extensions
GRANT SELECT, INSERT, UPDATE, DELETE ON rental_extensions TO "nexus-users";
GRANT ALL ON rental_extensions TO postgres;

-- Sequence permissions
GRANT USAGE, SELECT, UPDATE ON SEQUENCE rental_offers_id_seq TO "nexus-users";
GRANT USAGE, SELECT, UPDATE ON SEQUENCE rental_blocked_dates_id_seq TO "nexus-users";
GRANT USAGE, SELECT, UPDATE ON SEQUENCE rental_requests_id_seq TO "nexus-users";
GRANT USAGE, SELECT, UPDATE ON SEQUENCE rental_extensions_id_seq TO "nexus-users";
