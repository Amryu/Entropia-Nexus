...
GRANT SELECT, INSERT, UPDATE, DELETE ON trade_requests TO "nexus-users";
GRANT USAGE ON SEQUENCE trade_requests_id_seq TO "nexus-users";

GRANT SELECT, INSERT, UPDATE, DELETE ON trade_request_items TO "nexus-users";
GRANT USAGE ON SEQUENCE trade_request_items_id_seq TO "nexus-users";
