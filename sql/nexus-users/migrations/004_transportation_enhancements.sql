...
GRANT SELECT, INSERT, UPDATE, DELETE ON service_ticket_offers TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON service_tickets TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON service_ticket_usage TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON service_flight_instances TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON service_flight_state_log TO "nexus-users";
GRANT SELECT, INSERT, UPDATE, DELETE ON service_checkins TO "nexus-users";

-- Grant sequence access
GRANT USAGE, SELECT ON SEQUENCE service_ticket_offers_id_seq TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE service_tickets_id_seq TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE service_ticket_usage_id_seq TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE service_flight_instances_id_seq TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE service_flight_state_log_id_seq TO "nexus-users";
GRANT USAGE, SELECT ON SEQUENCE service_checkins_id_seq TO "nexus-users";
